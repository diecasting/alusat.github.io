...
def check_file(filepath):
    ...
    try:
        with open(filepath, "r", encoding="utf-8") as f:
            content = f.read()
        # Skip Hugo-generated redirect stub pages (meta-refresh only, e.g. the
        # default-language /en/ prefix redirect when defaultContentLanguageInSubdir=false).
        # These contain no real SEO content and must not fail the audit.
